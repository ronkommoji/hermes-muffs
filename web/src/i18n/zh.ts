...
export const zh: Translations = {
  ...
  integrations: {
    subtitle:
      "连接 Google Workspace（google-workspace 技能）、GitHub 与 MCP。使用当前 Hermes 配置文件。",
    googleTitle: "Google Workspace",
    googleBlurb:
      "在 Google Cloud 创建桌面 OAuth 客户端，粘贴 JSON，完成授权后保存令牌。",
    googleStep1: "在 API 库中启用 Gmail、Calendar、Drive、Sheets、Docs、People API。",
    googleStep2: "凭据 → 创建 OAuth 客户端 ID，类型选「桌面应用」，下载 JSON。",
    googleStep3: "将 JSON 粘贴到下方，生成授权链接，完成后再粘贴返回的 code 或完整重定向 URL。",
    googleSecretLabel: "OAuth 客户端 JSON",
    googleSecretHelp: "粘贴 Google 下载的凭据 JSON。",
    googleSaveSecret: "保存客户端 JSON",
    googleGetLink: "生成授权链接",
    googleOpenConsent: "打开 Google 授权页",
    googleCodeLabel: "授权码或重定向 URL",
    googleCodeHelp: "登录后，粘贴授权码或浏览器地址栏中的完整 URL。",
    googleFinish: "保存令牌",
    googleRevoke: "断开 Google",
    googleRevokeConfirm: "确定要移除此配置文件的 Google 令牌吗？",
    googleStatusOk: "已连接",
    googleStatusPartial: "已连接（部分权限未授权）",
    googleStatusNeedSecret: "需要 OAuth 客户端 JSON",
    githubTitle: "GitHub",
    githubBlurb: "保存个人访问令牌到密钥页，或通过 gh CLI 登录。",
    githubStep1: "在 GitHub 设置中创建 token（至少 repo 权限）。",
    githubPatLabel: "个人访问令牌",
    githubSavePat: "保存到密钥",
    githubStatusOk: "GitHub 已就绪",
    githubStatusCli: "已通过 gh CLI 登录",
    githubStatusToken: "已设置 GITHUB_TOKEN",
    githubStatusNone: "未连接",
    googleNotSignedIn: "客户端已保存 — 请完成下方授权",
    googleAuthOpened: "已在新标签页打开 Google 授权",
    googleAuthLinkCopied: "授权链接已复制",
    mcpTitle: "MCP 服务器",
    mcpBlurb: "在 config.yaml 的 mcp_servers 中配置 MCP。",
    mcpConfigured: "已配置 MCP",
    mcpCount: "配置中有 {count} 个服务器",
    mcpOpenYaml: "打开原始配置",
    moreTitle: "更多",
    moreBlurb: "大模型 OAuth 在「密钥」页；技能在「技能」页管理。",
    moreOAuthCard: "LLM 提供商 OAuth",
    moreSkillsCard: "技能目录",
    linkConsole: "Google Cloud 控制台",
    linkPat: "GitHub token",
    copiedUrl: "已在新标签页打开链接",
    saveFailed: "请求失败",
  },
